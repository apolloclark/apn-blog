...
variable "es_user_data" {
  default = "../files/es_user_data.sh"
}
variable "es_asg_min" {
  default = "2"
}
...
variable "logstash_user_data" {
  default = "../files/logstash_user_data.sh"
}
variable "logstash_asg_min" {
  default = "2"
}
variable "logstash_asg_max" {
  default = "5"
}
variable "logstash_asg_desired" {
  default = "2"
}
...
variable "kafka_user_data" {
  default = "../files/kafka_user_data.sh"
}
...
variable "kibana_user_data" {
  default = "../files/kibana_user_data.sh"
}
variable "kibana_asg_min" {
  default = "2"
}
...
variable "bastion_user_data" {
  default = "../files/bastion_user_data.sh"
}
...
variable "webapp_user_data" {
  default = "../files/webapp_user_data.sh"
}
variable "webapp_asg_min" {
  default = "2"
}
variable "webapp_asg_max" {
  default = "5"
}
variable "webapp_asg_desired" {
  default = "2"
}
